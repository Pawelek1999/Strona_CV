...
export const theme = {
  ...
  typography: {
    ...
    heading2: 'text-3xl font-black tracking-[0.08em] text-cyan-700 sm:text-4xl xl:text-5xl dark:text-cyan-300',
    heading3: 'text-lg font-semibold text-zinc-950 lg:text-xl dark:text-zinc-50',
    sectionTitle: 'text-3xl font-black tracking-[0.08em] text-cyan-700 sm:text-4xl xl:text-5xl dark:text-cyan-300',
    cvSectionTitle: 'text-3xl font-black tracking-[0.08em] text-cyan-700 sm:text-4xl xl:text-5xl dark:text-cyan-300',
    cvRoleTitle: 'text-xl font-black leading-tight text-zinc-950 lg:text-2xl dark:text-zinc-50',
    cvMeta: 'text-sm font-semibold leading-6 text-cyan-700 lg:text-base lg:leading-7 dark:text-cyan-300',
    subtitle: 'text-sm font-medium leading-7 text-zinc-700 sm:text-base lg:text-lg lg:leading-8 dark:text-zinc-300',
    body: 'text-base leading-8 text-zinc-700 lg:text-lg lg:leading-9 dark:text-zinc-300',
    caption: 'text-sm text-zinc-500 lg:text-base dark:text-zinc-400',
    eyebrow: 'text-sm font-medium uppercase tracking-wide text-zinc-500 lg:text-base dark:text-zinc-400',
    eyebrowAccent: 'text-xs font-bold uppercase tracking-[0.32em] text-cyan-700 lg:text-sm dark:text-cyan-200/80',
    labelAccent: 'text-xs font-bold uppercase tracking-[0.22em] text-cyan-700 lg:text-sm dark:text-cyan-200/80',
  },
  radius: {
    sm: 'rounded-md',
    md: 'rounded-lg',
  ...
  components: {
    ...
    headerBrand: 'text-sm font-bold uppercase tracking-wide text-zinc-50 transition-colors hover:text-cyan-200 xl:text-base',
    headerNav: 'hidden items-center gap-x-5 text-sm font-medium text-zinc-300 lg:flex lg:text-[0.95rem] xl:gap-x-7 xl:text-base',
    ...
    headerControl: 'flex rounded-full border border-white/10 bg-white/5 p-1 text-xs font-semibold xl:text-sm',
